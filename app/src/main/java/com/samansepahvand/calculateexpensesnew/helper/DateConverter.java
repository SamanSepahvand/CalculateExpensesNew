package com.samansepahvand.calculateexpensesnew.helper;
...
public class DateConverter {
    ...
    public  String[] nameOfDay=new String[]{
    ...
    public  String[] nameOfMonth=new String[]{
            "",
            "فروردین",
            "اردیبهشت" ,
            "خرداد",
    ...
    public String FarsiDay(int getDay) {
        return nameOfDay[getDay];
    }
    public String FarsiMonth(int getMoth) {
        return nameOfMonth[getMoth];
    }
